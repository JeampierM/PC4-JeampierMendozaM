...
def guardar_datos_en_archivo(cantidad_bitcoins, costo_actual_usd):
    try:
        with open("archivo_precios_bitcoins.txt", "a") as archivo:
            archivo.write(f"Cantidad de Bitcoins: {cantidad_bitcoins:.1f}, Costo en USD: ${costo_actual_usd:,.4f}\n")
...
def main():
    ...
    if precio_actual is not None:
        ...
        guardar_datos_en_archivo(cantidad_bitcoins, costo_actual_usd)
